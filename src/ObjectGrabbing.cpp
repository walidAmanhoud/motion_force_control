...
ObjectGrabbing::ObjectGrabbing(ros::NodeHandle &n, double frequency, std::string fileName, SurfaceType surfaceType, 
...
bool ObjectGrabbing::init() 
{
  ...
  _subRobotPose = _n.subscribe("/lwr/ee_pose", 1, &ObjectGrabbing::updateRobotPose, this, ros::TransportHints().reliable().tcpNoDelay());
  _subRobotTwist = _n.subscribe("/lwr/joint_controllers/twist", 1, &ObjectGrabbing::updateRobotTwist, this, ros::TransportHints().reliable().tcpNoDelay());
  _subForceTorqueSensor = _n.subscribe("/ft_sensor/netft_data", 1, &ObjectGrabbing::updateRobotWrench, this, ros::TransportHints().reliable().tcpNoDelay());
  _subOptitrackRobotBasisPose = _n.subscribe("/optitrack/robot/pose", 1, &ObjectGrabbing::updateOptitrackRobotPose,this,ros::TransportHints().reliable().tcpNoDelay());
  _subOptitrackPlane1Pose = _n.subscribe("/optitrack/plane1/pose", 1, &ObjectGrabbing::updateOptitrackP1Pose,this,ros::TransportHints().reliable().tcpNoDelay());
  _subOptitrackPlane2Pose = _n.subscribe("/optitrack/plane2/pose", 1, &ObjectGrabbing::updateOptitrackP2Pose,this,ros::TransportHints().reliable().tcpNoDelay());
  _subOptitrackPlane3Pose = _n.subscribe("/optitrack/plane3/pose", 1, &ObjectGrabbing::updateOptitrackP3Pose,this,ros::TransportHints().reliable().tcpNoDelay());
  ...
  _pubFilteredWrench = _n.advertise<geometry_msgs::WrenchStamped>("ObjectGrabbing/filteredWrench", 1);
  ...
  _pubNormalForce = _n.advertise<std_msgs::Float32>("ObjectGrabbing/normalForce", 1);
...
void ObjectGrabbing::updateRobotPose(const geometry_msgs::Pose::ConstPtr& msg)
{
  _msgRealPose = *msg;
...
void ObjectGrabbing::updateRobotTwist(const geometry_msgs::Twist::ConstPtr& msg)
{
  _v(0) = msg->linear.x;
  _v(1) = msg->linear.y;
  _v(2) = msg->linear.z;
...
void ObjectGrabbing::updateRobotWrench(const geometry_msgs::WrenchStamped::ConstPtr& msg)
{
...
void ObjectGrabbing::updateOptitrackRobotPose(const geometry_msgs::PoseStamped::ConstPtr& msg) 
{
...
void ObjectGrabbing::updateOptitrackP1Pose(const geometry_msgs::PoseStamped::ConstPtr& msg) 
{
...
void ObjectGrabbing::updateOptitrackP2Pose(const geometry_msgs::PoseStamped::ConstPtr& msg) 
{
...
void ObjectGrabbing::updateOptitrackP3Pose(const geometry_msgs::PoseStamped::ConstPtr& msg) 
{
